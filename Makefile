...
init:
	mkdir opt opt/data opt/data/mysql opt/data/elasticsearch opt/log opt/log/nginx opt/log/php opt/www
...
in-mysql:
	docker run -i -p 3306:3306  -v opt/data/mysql:/var/lib/mysql -e MYSQL_ROOT_PASSWORD=123456 -t env/mysql /bin/bash
